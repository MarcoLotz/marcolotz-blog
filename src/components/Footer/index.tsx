    ...
    <div className={styles.footer}>
      <Container className={styles.inner}>
        ...
        <Group spacing={0} className={styles.links} position="right" noWrap>
          <ActionIcon component="a" href="https://www.linkedin.com/in/marcolotz/" target="_blank"
                      size="lg" aria-label="Marco Lotz's Linkedin">
            <IconBrandLinkedin size="1.05rem" stroke={1.5}/>
          </ActionIcon>
          <ActionIcon component="a" href="https://twitter.com/lotzmarco" target="_blank" size="lg"
                      aria-label="Marco Lotz's Twitter">
            <IconBrandTwitter size="1.05rem" stroke={1.5}/>
          </ActionIcon>
          <ActionIcon component="a" href="https://github.com/marcolotz" target="_blank" size="lg"
          ...
          <ActionIcon component="a"
                      ...
                      target="_blank" size="lg" aria-label="Marco Lotz's Google Scholar">
